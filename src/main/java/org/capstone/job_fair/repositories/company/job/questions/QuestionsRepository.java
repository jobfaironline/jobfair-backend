...
public interface QuestionsRepository extends JpaRepository<QuestionsEntity, String> {
    ...
    Page<QuestionsEntity> findAllByContentContainsAndJobPositionIdAndJobPositionCompanyId(String searchContent, String jobPositionId, String companyId, Pageable pageable);
