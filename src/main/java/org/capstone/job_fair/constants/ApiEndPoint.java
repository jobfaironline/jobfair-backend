...
public final class ApiEndPoint {
    ...
    public static final class Demo {
        ...
        public static final String CREATE_JOB_FAIR_DRAFT_WITHOUT_ASSIGNMENT = DEMO_ENDPOINT + "/create-job-fair-draft-without-assignment";
        ...
        public static final String PUBLIC_JOB_FAIR = DEMO_ENDPOINT + "/public-job-fair";
    ...
    public static final class Company {
        ...
        public static final String STATISTICS = COMPANY_ENDPOINT + "/statistics";
    }
